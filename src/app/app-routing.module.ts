...
const routes: Routes = [
    { path: '', component: HomeComponent, canActivate: [AuthGuard],
      children: [
        ...
        { path: 'reports', loadChildren: () => import('./components/layout/home/reports/reports.module').then(m => m.ReportsModule) },
        { path: 'settings', loadChildren: () => import('./components/layout/home/settings/settings.module').then(m => m.SettingsModule) },        
      ] 
    },
